"""Madlibs Medical Thriller Stories."""


class MedicalThrillerStory:
    """A Mad Libs Medical Thriller Story.

    To create a Medical Thriller story, pass a list of prompts and the text
    of the template.
